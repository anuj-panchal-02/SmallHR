...
public class BillingController : BaseApiController
{
    ...
    public BillingController(
        ...
        ILogger<BillingController> logger) : base(logger)
    {
        _context = context;
    ...
    /// </summary>
    [HttpGet("webhooks")]
    public async Task<ActionResult<object>> GetWebhookEvents(
    ...
    /// </summary>
    [HttpPost("reconcile")]
    public async Task<ActionResult<object>> Reconcile([FromBody] ReconcileRequest? request = null)
    {
        return await HandleServiceResultAsync(
            async () =>
            {
